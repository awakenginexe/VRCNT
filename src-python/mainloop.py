...
run_mapping = {
    ...
    "download_progress_whisper_thai_weight":"/run/download_progress_whisper_thai_weight",
    "downloaded_whisper_thai_weight":"/run/downloaded_whisper_thai_weight",
    "download_cancelled_whisper_thai_weight":"/run/download_cancelled_whisper_thai_weight",
    "error_whisper_thai_weight":"/run/error_whisper_thai_weight",
    ...
    "download_cancelled_sensevoice_weight":"/run/download_cancelled_sensevoice_weight",
...
mapping = {
    ...
    "/get/data/selectable_whisper_thai_weight_type_dict": {"status": True, "variable":controller.getSelectableWhisperThaiWeightTypeDict},
    "/get/data/whisper_thai_model_catalog": {"status": True, "variable":controller.getWhisperThaiModelCatalog},
    ...
    "/run/download_whisper_thai_weight": {"status": True, "variable":controller.downloadWhisperThaiWeight},
    ...
    "/run/cancel_whisper_weight": {"status": True, "variable":controller.cancelWhisperWeight},
    "/run/cancel_whisper_thai_weight": {"status": True, "variable":controller.cancelWhisperThaiWeight},
    "/run/cancel_vosk_weight": {"status": True, "variable":controller.cancelVoskWeight},
    "/run/cancel_parakeet_weight": {"status": True, "variable":controller.cancelParakeetWeight},
    "/run/cancel_sensevoice_weight": {"status": True, "variable":controller.cancelSenseVoiceWeight},
