...
<p align="center">
  <img alt="Version" src="https://img.shields.io/badge/version-5.15.4-9B6DFF?style=for-the-badge&labelColor=08070B" />
...
ไฟล์ runtime ที่ stage แล้วจะอยู่ที่ `build/release/cpu` และ `build/release/cuda` ส่วน release สาธารณะใช้ WPF bootstrapper ขนาดเล็ก `VRCNT_5.15.4_Setup.exe` และ payload ทั้งสองแบบ
