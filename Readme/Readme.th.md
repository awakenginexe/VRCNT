...
ไฟล์ runtime ที่ stage แล้วจะอยู่ที่ `build/release/cpu` และ `build/release/cuda` ส่วน release สาธารณะใช้ WPF bootstrapper ขนาดเล็ก `VRCNT_5.15.3_Setup.exe` และ payload ทั้งสองแบบ
