        ...
        <div className={styles.container}>
            <section className={styles.hero}>
                ...
                <div className={styles.hero_text}>
                    <p className={styles.kicker}>VRCNT</p>
                    <h1 className={styles.title}>VRChat Next Translation</h1>
                    <p className={styles.description}>
                        VRCNT Unofficial next-generation translation tool for VRChat
                    </p>
                </div>
            </section>
            ...
            <section className={styles.notice}>
                ...
                <p className={styles.notice_text}>
                    This program is based from VRCT. VRCNT is an unofficial customized continuation focused on a modern workflow, clearer language controls, and practical VRChat translation use.
                </p>
            ...
            <section className={styles.info_grid}>
                <div className={styles.info_card}>
                    ...
                    <p className={styles.card_title}>VRCNT</p>
                    <p className={styles.card_text}>A dark aqua interface for translation, transcription, and VRChat message flow.</p>
                </div>
                <div className={styles.info_card}>
            ...
            <section className={styles.disclaimer}>
                <p>
                    VRCNT is not endorsed by VRChat and does not reflect the views or opinions of VRChat or anyone officially involved in producing or managing VRChat properties. VRChat and all associated properties are trademarks or registered trademarks of VRChat Inc.
                </p>
            </section>
        </div>
    );
