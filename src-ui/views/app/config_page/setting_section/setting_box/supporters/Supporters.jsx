        ...
        <div className={styles.container}>
            <section className={styles.hero}>
                ...
                <div className={styles.hero_text}>
                    ...
                    <p className={styles.description}>
                        VRCNT keeps growing from the original VRCT project and pushes the experience toward a more modern VRChat translation workflow.
                    </p>
                </div>
            </section>
            ...
            <section className={styles.notice}>
                ...
                <p className={styles.notice_text}>
                    This software is based on VRCT by misyaguziya. The original repository is the foundation this unofficial VRCNT build continues from.
                </p>
                <_OpenWebpageButton
            ...
            <div className={styles.info_grid}>
                <section className={styles.info_card}>
                    <p className={styles.card_label}>VRCNT</p>
                ...
                <section className={styles.info_card}>
                    ...
                    <p className={styles.card_text}>
                        VRCNT is moving toward a darker aqua interface with better scanning, less friction, and a layout that can keep evolving from here.
                    </p>
                </section>
            </div>

            <section className={styles.disclaimer}>
                VRCNT is an unofficial fork for VRChat translation workflows. VRCT remains the original project and deserves the source credit.
            </section>
        </div>
    );
};
