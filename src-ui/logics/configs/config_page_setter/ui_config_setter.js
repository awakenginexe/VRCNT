...
export const SETTINGS_ARRAY = [
    ...
    {
        Category: "Transcription",
        Base_Name: "UseSplitGroqApiKey",
        default_value: false,
        ui_template_id: "toggle",
        logics_template_id: "toggle_enable_disable",
        base_endpoint_name: "use_split_groq_api_key",
    },
    {
        Category: "Transcription",
        Base_Name: "GroqWhisperAuthKey",
        default_value: "",
        ui_template_id: "input",
        logics_template_id: "get_set_delete",
        base_endpoint_name: "groq_whisper_auth_key",
    },
    {
        Category: "Transcription",
        Base_Name: "SelectedWhisperCloudModel",
        default_value: "whisper-large-v3-turbo",
        ui_template_id: "select",
        logics_template_id: "get_set",
        add_endpoint_run_array: ["from_backend"],
        base_endpoint_name: "selected_whisper_cloud_model",
    },
    {
        Category: "Transcription",
        Base_Name: "SelectableTranscriptionEngineList",
        default_value: [],
        ui_template_id: "list",
    ...
    {
        Category: "Transcription",
        Base_Name: "SelectedTranscriptionEngineSend",
        default_value: "",
        ui_template_id: "select",
        logics_template_id: "get_set",
        add_endpoint_run_array: ["from_backend"],
    ...
    {
        Category: "Transcription",
        Base_Name: "SelectedTranscriptionEngineReceive",
        default_value: "",
        ui_template_id: "select",
        logics_template_id: "get_set",
        add_endpoint_run_array: ["from_backend"],
    ...
    {
        Category: "Transcription",
        Base_Name: "TranscriptionProfileSend",
        default_value: {},
        ui_template_id: "select",
        logics_template_id: "get_set",
        add_endpoint_run_array: ["from_backend"],
        base_endpoint_name: "transcription_profile_send",
    },
    {
        Category: "Transcription",
        Base_Name: "TranscriptionProfileReceive",
        default_value: {},
        ui_template_id: "select",
        logics_template_id: "get_set",
        add_endpoint_run_array: ["from_backend"],
        base_endpoint_name: "transcription_profile_receive",
    },
    {
        Category: "Transcription",
        Base_Name: "TranscriptionProfileAll",
        default_value: {},
        ui_template_id: "select",
        logics_template_id: "get_set",
        base_endpoint_name: "transcription_profile_all",
    },
    {
        Category: "Transcription",
    ...
    {
        Category: "Transcription",
        Base_Name: "SelectedTranscriptionComputeTypeSend",
        default_value: "",
        ui_template_id: "select",
        logics_template_id: "get_set",
        add_endpoint_run_array: ["from_backend"],
        base_endpoint_name: "selected_transcription_compute_type_send",
    },
    {
        Category: "Transcription",
        Base_Name: "SelectedTranscriptionComputeTypeReceive",
        default_value: "",
        ui_template_id: "select",
        logics_template_id: "get_set",
        add_endpoint_run_array: ["from_backend"],
        base_endpoint_name: "selected_transcription_compute_type_receive",
    },
    {
        Category: "Transcription",
    ...
    {
        Category: "Transcription",
        Base_Name: "SelectedTranscriptionComputeDeviceSend",
        default_value: "",
        ui_template_id: "select",
        logics_template_id: "get_set",
        add_endpoint_run_array: ["from_backend"],
        base_endpoint_name: "selected_transcription_compute_device_send",
    },
    {
        Category: "Transcription",
        Base_Name: "SelectedTranscriptionComputeDeviceReceive",
        default_value: "",
        ui_template_id: "select",
        logics_template_id: "get_set",
        add_endpoint_run_array: ["from_backend"],
        base_endpoint_name: "selected_transcription_compute_device_receive",
    },
    // Advanced
    {
        Category: "Transcription",
