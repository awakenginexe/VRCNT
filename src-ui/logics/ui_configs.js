export const ui_configs = {
    ...
    _overlay_log_config: {
        ...
        message_text_scale: { step: 10, min: 40, max: 200 },
    },
...
export const whisper_thai_weight_type_status = [
    {
        id: "thai-thonburian-small",
        label: "Thonburian Thai Small (Experimental)",
        display_name: "Thonburian Thai Small (Experimental)",
        family: "BioDataLab / Thonburian Whisper",
        source: "biodatlab/whisper-th-small-combined",
        host: "Thaweewat",
        capacity: "484MB",
        size_mb: 484,
        license: "Apache-2.0",
        quantization: "CT2 INT8",
        architecture: "Whisper Small",
        language_coverage: "Thai only",
        experimental: true,
    },
    {
        id: "thai-thonburian-medium",
        label: "Thonburian Thai Medium",
        display_name: "Thonburian Thai Medium",
        family: "BioDataLab / Thonburian Whisper",
        source: "biodatlab/whisper-th-medium-combined",
        host: "Vinxscribe",
        capacity: "1.53GB",
        size_mb: 1528,
        license: "MIT",
    ...
    {
        id: "thai-thonburian-large-v2",
        label: "Thonburian Thai Large V2",
        display_name: "Thonburian Thai Large V2",
        family: "BioDataLab / Thonburian Whisper",
        source: "biodatlab/whisper-th-large-combined",
        host: "mort666",
        capacity: "3.09GB",
        size_mb: 3087,
        license: "MIT",
    ...
    {
        id: "thai-thonburian-large-v3-int8",
        label: "Thonburian Thai Large V3 INT8",
    ...
    {
        id: "thai-thonburian-distilled-large-v3",
        label: "Thonburian Thai Distilled Large V3",
        ...
        license: "MIT",
        quantization: "CT2 INT8",
        architecture: "Distilled Whisper Large V3",
        language_coverage: "Thai only",
        experimental: false,
    },
    {
        id: "thai-mort666-large-v3-fp16",
        label: "mort666 Thai Large V3 FP16",
        display_name: "mort666 Thai Large V3 FP16",
        family: "mort666 Thai Whisper fine-tune",
        source: "mort666/whisper-large-v3-th-fp16",
        host: "mort666",
        capacity: "3.09GB",
        size_mb: 3087,
        license: "MIT",
