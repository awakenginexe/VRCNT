...
test("the app and desktop overlay use one editable semantic visual system", () => {
    ...
    assert.equal(appVariables["--accent_color"], "#38BDF8");
    assert.equal(appVariables["--bg_gradient_start"], "#060810");
    assert.equal(appVariables["--success_color"], "#5BE2B5");
    assert.equal(appVariables["--canvas_color"], "#060810");
    assert.match(variables, /--palette_primary_color:\s*#38BDF8/i);
    assert.match(variables, /--palette_background_start_color:\s*#060810/i);
    assert.match(variables, /--palette_success_color:\s*#5BE2B5/i);
    assert.match(variables, /--palette_canvas_color:\s*#060810/i);
